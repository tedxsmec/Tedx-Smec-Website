...
//   instagram: m.instagram || m.instagramUrl || m.instagram_link || null,
...
//         {showSocials && (
//           <div className="absolute top-4 right-4 z-20 flex flex-col gap-3 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
